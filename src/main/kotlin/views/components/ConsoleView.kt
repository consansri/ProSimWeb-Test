...
import kotlinx.js.timers.clearImmediate
...
external interface ConsoleViewProps : Props {
...
val ConsoleView = FC<ConsoleViewProps>() { props ->
    ...
    div {
        ...
        div {
            ...
            for (message in iConsole.getMessages()) {
