            ...
            try {
                when (format) {
                    ExportFormat.VHDL -> {
                        ...
                        // Auto Generated
                        content.add(
                            "\n-- \n-- Generated by ${ArchConst.PROSIMNAME} ${architecture.getName()} \n-- on ${date.toDateString()} ${date.toTimeString()}" +
                                    "\n-- " +
                                    "\n-- Input file:" +
                    ...
                    ExportFormat.MIF -> {
                        ...
                        content.add(
                            "\n" +
                                    ...
                                    "\n-- created on ${date.toDateString()} ${date.toTimeString()}" +
                                    "\n-- by ${ArchConst.PROSIMNAME} ${architecture.getName()}"
                        )

                        var contentString = ""

                        for (line in 0..<depth.roundToLong()) {
