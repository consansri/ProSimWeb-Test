...
class CSpinnerUI : BasicSpinnerUI() {
    ...
    fun setDefaults(spinner: CSpinner) {
        ...
        spinner.foreground = States.theme.get().textLaF.base
    ...
    override fun createNextButton(): Component {
        val button = CIconButton(States.icon.get().increase, CIconButton.Mode.PRIMARY_SMALL, hasHoverEffect = false)
        installNextButtonListeners(button)
        return button
    }

    override fun createPreviousButton(): Component {
        val button = CIconButton(States.icon.get().decrease, CIconButton.Mode.PRIMARY_SMALL, hasHoverEffect = false)
