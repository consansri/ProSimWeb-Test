...
object RV32 {
    ...
    val standardRegFile = RegContainer.RegisterFile(
        MAIN_REGFILE_NAME, arrayOf(
            ...
            Register(Bin("01101", REG_ADDRESS_SIZE), listOf("x13"), listOf("a3"), Variable(REG_INIT, REG_VALUE_SIZE), CallingConvention.CALLER, "function argument 3"),
            Register(Bin("01110", REG_ADDRESS_SIZE), listOf("x14"), listOf("a4"), Variable(REG_INIT, REG_VALUE_SIZE), CallingConvention.CALLER, "function argument 4"),
            ...
            Register(Bin("10101", REG_ADDRESS_SIZE), listOf("x21"), listOf("s5"), Variable(REG_INIT, REG_VALUE_SIZE), CallingConvention.CALLEE, "saved register 5"),
            Register(Bin("10110", REG_ADDRESS_SIZE), listOf("x22"), listOf("s6"), Variable(REG_INIT, REG_VALUE_SIZE), CallingConvention.CALLEE, "saved register 6"),
            Register(Bin("10111", REG_ADDRESS_SIZE), listOf("x23"), listOf("s7"), Variable(REG_INIT, REG_VALUE_SIZE), CallingConvention.CALLEE, "saved register 7"),
            Register(Bin("11000", REG_ADDRESS_SIZE), listOf("x24"), listOf("s8"), Variable(REG_INIT, REG_VALUE_SIZE), CallingConvention.CALLEE, "saved register 8"),
