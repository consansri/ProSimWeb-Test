...
class RV32Instr(val instrType: RV32Syntax.InstrType, val paramType: RV32Syntax.ParamType, nameToken: Token, allTokens: List<Token>, nodes: List<Node>) : GASNode.Instruction(nameToken, allTokens, nodes){
