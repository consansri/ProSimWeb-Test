...
sealed class Component {
     ...
     */
    abstract fun matchStart(source: List<Token>, allDirs: List<DirTypeInterface>, definedAssembly: DefinedAssembly, assignedSymbols: List<GASParser.Symbol>): Rule.MatchResult
    ...
    class Optional(comp: () -> Component) : Component() {
        ...
        override fun matchStart(source: List<Token>, allDirs: List<DirTypeInterface>, definedAssembly: DefinedAssembly, assignedSymbols: List<GASParser.Symbol>): Rule.MatchResult {
