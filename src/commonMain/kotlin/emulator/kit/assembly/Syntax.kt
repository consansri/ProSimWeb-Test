...
abstract class Syntax {
    ...
    abstract fun clear()
    abstract fun check(arch: emulator.kit.Architecture, compiler: Compiler, tokens: List<Compiler.Token>, others: List<FileHandler.File>, transcript: Transcript): SyntaxTree
