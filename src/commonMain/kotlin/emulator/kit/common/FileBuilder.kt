...
class FileBuilder {
    ...
    fun buildFileContentLines(architecture: Architecture, format: ExportFormat, vararg settings: Setting): List<String> {
        when (format) {
            ...
            ExportFormat.CURRENT_FILE -> {
                return architecture.getFileHandler().getCurrContent().split("\n")
            }
        }
    }
