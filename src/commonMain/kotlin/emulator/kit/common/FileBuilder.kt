 ...
 */
class FileBuilder {
    fun buildFileContentLines(architecture: Architecture, format: ExportFormat, fileContent: String, tree: Syntax.LinkedTree, vararg settings: Setting): List<String> {
        when (format) {
                    ...
                    try {
                        when (format) {
                            ExportFormat.VHDL -> {
                                ...
                                // Auto Generated
                                content.add(
                                    "\n-- \n-- Generated by ${Settings.PROSIMNAME} ${architecture.getDescription().name} \n-- on ${now}" +
                                            "\n-- " +
                                            "\n-- Input file:" +
                                            "\n-- \t${tree.name}" +
                                            "\n--" +
                                            "\n-- Output file:" +
                                            "\n-- \t${tree.name.removeFileEnding() + format.ending}" +
                                            "\n-- "
                                )
                            ...
                            ExportFormat.MIF -> {
                                ...
                                content.add(
                                    "\n" +
                                            ...
                                            "\n-- created on ${now}" +
                                            "\n-- by ${Settings.PROSIMNAME} ${architecture.getDescription().name}"
                                )
