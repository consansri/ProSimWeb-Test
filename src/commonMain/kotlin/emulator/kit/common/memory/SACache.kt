...
class SACache(
    ...
    constructor(backingMemory: Memory, console: IConsole, blockCount: Int, cacheSize: CacheSize, replaceAlgo: Model.ReplaceAlgo, name: String = "$cacheSize Cache (${blockCount}SA ${replaceAlgo})") : this(
        backingMemory,
        console,
        blockCount = blockCount,
