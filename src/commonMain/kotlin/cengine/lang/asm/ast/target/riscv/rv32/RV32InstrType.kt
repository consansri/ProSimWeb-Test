        ...
        when (this.paramType) {
            RV32ParamType.RD_I20 -> {
                ...
                if (!imm.checkSizeSignedOrUnsigned(Size.Bit20)) {
                    expr.notations.add(Notation.error(expr, "${expr.evaluated} exceeds ${Size.Bit20}."))
                }
            ...
            RV32ParamType.RD_OFF12 -> {
                ...
                if (!imm.checkSizeSignedOrUnsigned(Size.Bit12)) {
                    expr.notations.add(Notation.error(expr, "${expr.evaluated} exceeds ${Size.Bit12}."))
                }
            ...
            RV32ParamType.RD_RS1_RS2 -> {
                ...
                val funct7 = when (this) {
                    SRA -> RVConst.FUNCT7_SHIFT_ARITH
                    SUB -> RVConst.FUNCT7_OPERATION_SUB
            ...
            RV32ParamType.RD_RS1_SHAMT5 -> {
                ...
                val funct7 = when (this) {
                    SRAI -> RVConst.FUNCT7_SHIFT_ARITH
                    else -> 0U
                }
                val funct3 = when (this) {
                ...
                if (!imm.checkSizeSignedOrUnsigned(Size.Bit5)) {
                    expr.notations.add(Notation.error(expr, "$imm exceeds ${Size.Bit5}."))
                }
            ...
            RV32ParamType.PS_RD_I32 -> {
                ...
                if (!imm.checkSizeSignedOrUnsigned(Size.Bit32)) {
                    expr.notations.add(Notation.error(expr, "$imm exceeds ${Size.Bit32}."))
                }
