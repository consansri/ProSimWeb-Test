...
import cengine.lang.obj.elf.ELFBuilder.Section
...
class RelocatableELFBuilder(
    ...
    constructor(spec: TargetSpec, e_flags: cengine.lang.obj.elf.Elf_Word = 0U) : this(spec.ei_class, spec.ei_data, spec.ei_osabi, spec.ei_abiversion, spec.e_machine, e_flags)
